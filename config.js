...
const aboutContent = {
    en: {
        content1: "I am an undergraduate student majoring in Spatial Information and Digital Technology at the School of Remote Sensing and Information Engineering, Wuhan University, expected to graduate in 2026. I have been recommended for postgraduate studies at the Innovation Academy of Precision Measurement Science and Technology, Chinese Academy of Sciences, and work as a research assistant at the National Key Laboratory of Surveying, Mapping and Remote Sensing, Wuhan University, with a research focus on autonomous positioning and perception of unmanned systems under the guidance of Professor Zhang Baocheng and Professor Li You.",
    ...
    zh: {
        content1: "我是武汉大学遥感信息工程学院空间信息与数字技术专业本科生，预计2026年毕业。目前已推免保研至中国科学院精密测量科学与技术创新研究院，兼武汉大学测绘遥感信息国家重点实验室科研助理，预计研究方向为无人系统自主定位与感知，在张宝成教授和李由教授的指导下开展相关研究工作。",
        content2: "本科期间积极参与多项大学生机器人赛事，均获得国家级奖项，在此过程中，学习积累了丰富的机器人开发知识与经验。",
    ...
    common: {
        education: [
            ...
            },
            {
                ...
                institution: {
                    en: "Innovation Academy of Precision Measurement Science and Technology, University of Chinese Academy of Sciences",
                    zh: "中国科学院大学 精密测量科学与技术创新研究院"
                },
                major: {
                ...
                advisor: {
                    en: "Professor Zhang Baocheng",
                    zh: "张宝成教授"
                },
                research: {
                    en: "Satellite Precision Orbit Determination and Integrated Navigation",
                    zh: "卫星精密定位定轨及组合导航"
                },
                details: []
            },
